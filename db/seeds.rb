...
#Options
Option.create(name: "Shut down ship to avoid detection", quad: false, dual: true, issue_id: 1)
Option.create(name: "Run and hope they don't chase", quad: false, dual: true, issue_id: 1)
Option.create(name: "Fix engine parts", quad: true, dual: false, issue_id: 2)
Option.create(name: "Replace engine parts", quad: true, dual: false, issue_id: 2)
Option.create(name: "Abandon Saffron on deserted planet", quad: false, dual: true, issue_id: 3)
Option.create(name: "Take on a new client", quad: false, dual: true, issue_id: 4)
Option.create(name: "Turn her into authorities", quad: true, dual: false, issue_id: 5)
Option.create(name: "Protect her from authorities", quad: true, dual: false, issue_id: 5)
Option.create(name: "Keep Atherton as a client", quad: false, dual: true, issue_id: 6)
Option.create(name: "Tell parents I have River", quad: false, dual: true, issue_id: 7)
Option.create(name: "Hide River from parents", quad: false, dual: true, issue_id: 7)
Option.create(name: "Have dealings with Patience", quad: false, dual: true, issue_id: 8)
